...
from external_benchmarks.adriatic.common import read_csv_rows, write_json  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the current VGG16 whistle detector on a prepared Adriatic flat "
            "staging directory produced by prepare_adriatic_clip_benchmark.py."
        ),
...
def main() -> None:
    ...
    print(
        "Next step       : python external_benchmarks/adriatic/"
        "evaluate_adriatic_clip_metrics.py "
