...
def staged_file_name(
    ...
    kind_slug = safe_slug(clip_kind or "clip", max_length=48)
    return f"{index:05d}__{label_slug}__{kind_slug}__{onset_ms:09d}_{offset_ms:09d}{suffix}"


def gcs_download_url(object_name: str) -> str:
    from urllib.parse import quote

    encoded_name = quote(object_name, safe="")
    return (
        "https://storage.googleapis.com/download/storage/v1/b/noaa-passive-bioacoustic/o/"
